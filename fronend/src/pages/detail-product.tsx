...
const DetailProduct = () => {
  ...
  // add to cart
  const addToCart = (buyCount: number, idPro: string) => {
    ...
    addtoCartUser(buyCount, userExit.userId._id, idPro).then((data) => {
      ...
      <div className="detail-product">
        ...
        <div className="box-center">
          <img
            src={product?.image}
            alt=""
            style={{ width: "500px", height: "300px", marginLeft: "50px" }}
          />
        </div>
          ...
          <div className="addToCart">
            ...
            <div className="add">
              <p
                className=""
                onClick={() => {
                  addToCart(buyCount, product._id);
                }}
              >
                Add To Cart
              </p>
          ...
          <div className="parameter">
            ...
            <div className="child-parameter">
              ...
              <div className="icon">
                {" "}
                :{" "}
                <a href="https://www.facebook.com/andecu24">
